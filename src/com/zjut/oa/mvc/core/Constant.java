...
public interface Constant {
	...
	int DEFAULT_CURRENT_PAGE = ConfigTool.DEFAULT_PAGE;
	/** 分页时默认当前页码 =1 */
	int DEFAULT_COUNT_PER_PAGE = ConfigTool.COUNT_PER_PAGE;
	/** 分页时默认分页大小 =20 */
	int DEFAULT_MAX_PAGERSHOW_LENGTH = ConfigTool.DEFAULT_LENGTH_PER_PAGE_SHOW;
	/** 分页时左右分页区间大小 */

	String PAGER_KEY = "pager";
	/** 分页时分页键 */
	String MAX_PAGERSHOW_LENGTH_KEY = "maxPagerShowLength";
	/** 分页时左右分页区间键 */
	String CURRENT_PAGE_KEY = "currentPage";
	/** 分页时当前页键 */
	String CURRENT_COUNT_PER_PAGE_KEY = "countPerPage";
	/** 分页时当前分页大小键 */
	...
	String PAGE_IMPORTUSER_FAILLIST_KEY = "failList";
